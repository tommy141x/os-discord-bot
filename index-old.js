...
client.once("ready", () => {
  ...
  const defaultSettings = {
    logSettings: {
      logMemberBans: { enabled: true, channelId: defaultChannelId },
      logMemberUnbans: { enabled: false, channelId: defaultChannelId },
      logMemberLeaves: { enabled: true, channelId: defaultChannelId },
      logMemberJoins: { enabled: true, channelId: defaultChannelId },
      logMemberUpdates: { enabled: false, channelId: defaultChannelId },
      logChannelCreations: { enabled: false, channelId: defaultChannelId },
      logChannelDeletions: { enabled: false, channelId: defaultChannelId },
      logChannelUpdates: { enabled: false, channelId: defaultChannelId },
      logThreadCreations: { enabled: false, channelId: defaultChannelId },
      logThreadDeletions: { enabled: false, channelId: defaultChannelId },
      logThreadUpdates: { enabled: false, channelId: defaultChannelId },
      logRoleCreations: { enabled: false, channelId: defaultChannelId },
      logRoleDeletions: { enabled: false, channelId: defaultChannelId },
      logRoleUpdates: { enabled: false, channelId: defaultChannelId },
      logMessageCreation: { enabled: true, channelId: defaultChannelId },
      logMessageDeletions: { enabled: false, channelId: defaultChannelId },
      logMessageEdits: { enabled: false, channelId: defaultChannelId },
      logVoiceStateUpdates: { enabled: false, channelId: defaultChannelId },
      logInviteCreations: { enabled: false, channelId: defaultChannelId },
      logInviteDeletions: { enabled: false, channelId: defaultChannelId },
      logServerUpdates: { enabled: false, channelId: defaultChannelId },
      logPermissionUpdates: { enabled: false, channelId: defaultChannelId },
    },
    utilitySettings: {
      pingCommand: true,
      userCommand: true,
